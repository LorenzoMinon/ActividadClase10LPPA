...
var modalContent = document.getElementById('modalResponse')
...
function validarEdad() {
  ...
  function enviarFormulario(event) {
    ...
    // CLASE 10, CREAR RTA DEL SERVIDOR.
    ...
    .then(function(data){
        ...
        // Crear elementos para el mensaje y el objeto JSON
        var successMessage = document.createElement('p');
        var jsonData = document.createElement('pre');
      
        // Asignar contenido y estilos al mensaje de suscripción exitosa
        successMessage.textContent = "Suscripción exitosa";
        successMessage.style.fontWeight = "bold";
      
        // Asignar contenido y estilos al objeto JSON
        jsonData.textContent = JSON.stringify(data, null, 2);
        jsonData.style.backgroundColor = "#f5f5f5";
        jsonData.style.padding = "10px";
      
        // Insertar los elementos en el contenido del modal
        modalContent.appendChild(successMessage);
        modalContent.appendChild(jsonData);
      })
